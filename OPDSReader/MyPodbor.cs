...
{
    public partial class MyPodbor : Form
    {

        DataBase dataBase = new DataBase();
        private readonly checkUser _user;
        public MyPodbor(checkUser user)
        {
            InitializeComponent();
        ...
        private void MyPodbor_Load(object sender, EventArgs e)
        {
            string queryString = $"select * from podbor where id_author = '" + _user.Login + "'";
